---
title: "📊 Trade Review: $BRKR - Strong Profits, Early Exit?"
date: 2025-11-16 11:00:00 0100
categories: [Trade review]
tags: [brkr, trade-review]
image:
  path: /assets/img/2025/november/brkr-overview-weekly.png
  lqtip:
published: true
---

Bruker Corp. $BRKR was unknown to me until I first saw it in my X-feed two months ago. It caught my attention after noticing we had a Covid low-liquidity sweep followed by the build-up of a high-conviction trigger. I decided to enter a large position, and in this post I am walking through my thought process of a trade that realized a 22% gain on position for my [25 Year Trading Experiment](https://www.tradergu.com/25-year-trading-experiment/) portfolio.

As $BRKR caught my attention, I also published a [Video Chart Analysis](https://youtu.be/ArGwsYaAGZM) on my YouTube page.
...
![$BRKR](/assets/img/2025/november/brkr-process-monthly.png) *$ASML - Long-Term Watchlist monthly chart*
...
![$BRKR](/assets/img/2025/november/brkr-entry-weekly.png)  
*$BRKR - Entry, weekly*

---

### ✅ Added to Position
Already two days after my first entry, we had reached my target zone, and I added to position at $34.15, ending up an average $35.44 position. The trade took over a whopping [24% of my portfolio with a 6% risk on invested capital](https://x.com/trader_gu/status/1976605377698628073) - high-conviction to say the least.
...
![$BRKR](/assets/img/2025/november/brkr-added-to-position-daily.png)  
...
![$BRKR](/assets/img/2025/november/brkr-first-targets.png)  
*$BRKR - First Targets, weekly*
...
![$BRKR](/assets/img/2025/november/brkr-exit-weekly.png)  
*$BRKR - Exit position, weekly*
